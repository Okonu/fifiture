<div class="col-lg-4">
   <div class="right_sidebar">
      ...
      <aside class="r_widgets social_widgets mt-5">
         ...
         <ul class="list">
            <li><a href="#"><i class="fa fa-facebook"></i>Fifiture<span>Like our page</span></a></li>
            <li><a href="#"><i class="fa fa-twitter"></i>Fifiture<span>Follow Us</span></a></li>
            <li><a href="#"><i class="fa fa-instagram"></i>Fifiture<span>Follow Us</span></a></li>
