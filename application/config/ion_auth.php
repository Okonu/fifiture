...
$config['admin_e']                = "admin@example.com"; // Admin Email, admin@example.com
 ...
 */
$config['use_ci_e'] = TRUE; // Send Email using the builtin CI email class, if false it will return the code and the identity
$config['email_config'] = [
	'protocol'  => 'smtp',
